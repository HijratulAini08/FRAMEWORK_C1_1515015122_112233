...
class dosen_matakuliah extends Model
{
    ...
    {
        return $this->hasMany(jadwal_matakuliah::class,'dosen_matakuliah');// return nilai fungsi jadwal_matakuliah, dimana nilai return tersebut memiliki metode dengan nama hasMany.
